...
<label class="ui label" ref="prefix">{{ctx.component.prefix}}</label>
{% } %}
...
<div class="ui label" ref="suffix">{{ctx.component.suffix}}</div>
{% } %}
</div>
